...
//        mMap = googleMap;
        ...
        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(49.828575, 24.005964))
                .title("Франківський районний відділ поліції")
                .snippet("вул. Генерала Чупринки, 65"));

        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(49.843883, 24.019660))
                .title("Шевченківський районний відділ поліції")
                .snippet("вул. Академіка Романа Кучера, 5"));

        mMap.addMarker(new MarkerOptions()
                .position(new LatLng(49.833691, 24.038584))
                .title("Личаківський районний відділ поліції")
                .snippet("вул. Романчука, 18"));
